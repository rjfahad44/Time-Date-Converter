...
@Entity(tableName = "time_zone_list_table")
public class TimeZoneListModel {
    ...
    public TimeZoneListModel(String city, String city_ascii, String lat, String lng, String pop, String country, String iso2, String iso3, String province, String timezone, String utc_offset, String utc_dst, String code, String parent_code, String title, String location, String week_end) {
        this.city = city;
